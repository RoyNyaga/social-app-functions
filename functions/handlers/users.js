...
exports.signup = (req, res) => {
  ...
  const profileImg = 'blank-profile-picture-973460_1280.png'
  ...
  db.doc(`/users/${newUser.handle}`).get()
    ...
    .then((idToken) => {
      ...
      const userCredentials = {
        ...
        imagUrl: `https://firebasestorage.googleapis.com/v0/b/${config.storageBucket}/o/${profileImg}?alt=media`,
        userId
      }
...
exports.addUserDetails = (req, res) => {
  var userDetails = reducedUserDetails(req.body)
...
exports.markNotificationsRead = (req, res) => {
  ...
  req.body.forEach(notificationId => {
    var notification = db.doc(`/notifications/${notificationId}`)
